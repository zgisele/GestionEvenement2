    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admineRegister') }}">
                        @csrf
                        ...
                        <div class="row mb-3">
                            ...
                            <label for="dateCreation" class="col-md-4 col-form-label text-md-end">{{ __('Date Creation') }}</label>

                            <div class="col-md-6">
                                <input id="dateCreation" type="date" class="form-control @error('dateCreation') is-invalid @enderror" name="dateCreation" value="{{ old('dateCreation') }}" required autocomplete="dateCreation" autofocus>
